...
class NativeWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_get_devices(NativePortType port_);

  external dynamic /* void */ wire_add_number(
...
class NativeWire extends FlutterRustBridgeWasmWireBase<NativeWasmModule> {
  ...
  void wire_get_devices(NativePortType port_) =>
      wasmModule.wire_get_devices(port_);

  void wire_add_number(NativePortType port_, double a, double b) =>
      wasmModule.wire_add_number(port_, a, b);
