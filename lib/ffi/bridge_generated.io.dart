...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_get_devices(
    int port_,
  ) {
    return _wire_get_devices(
      port_,
    );
  }

  late final _wire_get_devicesPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_get_devices');
  late final _wire_get_devices =
      _wire_get_devicesPtr.asFunction<void Function(int)>();

  void wire_add_number(
    int port_,
    double a,
    double b,
  ) {
    return _wire_add_number(
      port_,
      a,
      b,
    );
  ...
  late final _wire_add_numberPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Float, ffi.Float)>>('wire_add_number');
  late final _wire_add_number =
      _wire_add_numberPtr.asFunction<void Function(int, double, double)>();
