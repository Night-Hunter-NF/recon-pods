...
fn wire_get_devices_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
        ...
        move || move |task_callback| Ok(get_devices()),
    )
}
fn wire_add_number_impl(
    port_: MessagePort,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            ...
            move |task_callback| Ok(add_number(api_a, api_b))
        },
    )
}
