...
void wire_get_devices(int64_t port_);

void wire_add_number(int64_t port_, float a, float b);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) wire_get_devices);
    dummy_var ^= ((int64_t) (void*) wire_add_number);
